// ✏️ 修改这里：APP 主页入口
// 快递取件码 / 我给[全体取件人]做了一个[快递取件码管理器] / 自动识别短信中的取件码并生成待办清单 / hsl(220, 90%, 62%) 会被 create-app.ps1 自动替换
    ...
    <main style={{ minHeight: "100vh", display: "flex", flexDirection: "column" }}>
      ...
      <section className="animate-in" style={{
        ...
        <h1 style={{ fontSize: "clamp(2rem, 5vw, 3.5rem)", fontWeight: 700, lineHeight: 1.15 }}>
          <span className="gradient-text">我给[全体取件人]做了一个[快递取件码管理器]</span>
        </h1>
      ...
      <footer style={{
        ...
        © {new Date().getFullYear()} 快递取件码 · 专注解决一个问题
      </footer>
    </main>
  );
}
